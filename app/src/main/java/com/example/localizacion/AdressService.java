...
public class AdressService extends IntentService {
    ...
    protected void onHandleIntent(@Nullable Intent intent) {
        ...
        if(intent != null) {
            ...
            if(addresses == null || addresses.isEmpty()) {
                ...
                deliverResultToReceiver(Constantes.SUCCESS_RESULT, TextUtils.join(Objects.requireNonNull(System.getProperty("line separator")), addressFragments));
            }
